...
export const PRODUCT_MAPPING = {
  ...
  'Luce nabè per letto evolutivo zero+': {
  handle: 'lampadina-nabe-per-letto-zeropiu',
  name: 'Luce nabè per letto evolutivo zero+',
  description: 'Consigliato per il letto zero+ Dream. Luce nabè è l\'abat-jour ideale per illuminare i momenti di lettura e di gioco dei tuoi bambini nel loro lettino montessoriano zero+. Con il suo design a cavo arrotolabile può essere posizionata all\' altezza e alla distanza che preferisci dalla testa, rendendola adatta per ogni situazione. La lunghezza del cavo è stata progettata per poter arrivare ad una presa vicino al letto pur lasciando l\' interruttore sempre a portata. Il suo paralume è in legno resistente e protegge la lampadina da urti mantenendola sempre in sicurezza da possibili maneggiamenti. Luce nabè funziona con una lampadina LED con attacco E14, fornita in omaggio. Luce nabè è la lampada ideale per lettini montessori. Realizzata con paralume in legno naturale tornito e cavo tessile è in cotone e lino naturale con una trama raffinata e disponibile in tre colori: Verde Zeno, Celeste Santiago, Rosa Sveva. Tre colori pastello dall\'effetto opaco e naturale. Il portalampada doppia ghiera è realizzato in termoplastica E14 con serracavo. Tutto è realizzato in Italia. Luce nabè ha una lunghezza totale di 430cm. L\'interruttore è posizionato a 230cm. Paralume in legno: Altezza: 15cm Diametro: 6cm Diametro del foro interno: 5,6 cm Portalampada: Attacco per lampadine: E14 Tensione nominale: 250 Vac. Morsetti: a vite per cavi rigidi o flessibili da 0,5 ÷ 2,5 mm2. Fissaggio: con foro filettato M10x1. Certificazioni: CE - IMQ. Cavo Tessile: Certificazione IMQ-HAR. Doppio isolamento. Conforme CEI 20-20 CEI 20-35 RoHS. Diametro: 6,2 mm 2x0,75 o 6,6 mm 3x0,75. Spina: Tipo C, europea 2 Poli Materiale: termoplastica Tensione nominale: 250V Corrente nominale 2,5A Grado di protezione: IP20 Luce nabè è conforme a tutte le normative di sicurezza Italiane ed Europee. Luce nabè non necessita di particolare manutenzione. L\'installazione e il ricambio della lampadina deve essere effettuato sempre da un adulto.',
  category: 'accessori'
},
'Comodino per letto evolutivo zero+': {
  handle: 'comodino-nabe-per-letto-zeropiu',
  name: 'Comodino per letto evolutivo zero+',
  description: 'Comodino nabè per letto montessoriano zeropiù Completa il tuo letto zeropiù con l\'iconico comodino nabè! Un prodotto unico progettato per integrarsi perfettamente con il letto zeropiù e proposto in due varianti: Comodino integrato alla sponda protettiva nabè, pensato per i bambini più piccoli e disponibile per lato destro e sinistro del letto; Comodino per letto senza sponde , posizionabile con la vite in dotazione ai 4 lati del letto oppure senza vite all\'altezza che preferisci. Il comodino nabè è sicuro! E\' realizzato in legno massello e dotato di sistema di ancoraggio alla struttura e di staffa angolare di supporto che lo rende super resistente! Il comodino nabè è comodo! E\' studiato delle dimensioni ideali per contenere tutti gli oggetti che utilizziamo vicino al letto, da bambini e da grandi. Il comodino nabè è bello! Si integra perfettamente con il design del letto montessoriano zeropiù e la sua forma tondeggiante è un piacere per gli occhi. Il comodino nabè è realizzato in Italia con pregiato legno massello di abete di Svezia , privo di formaldeide, solventi e di ogni sostanza additiva. 100% legno naturale selezionato, certificato FSC per garantire all\'origine un corretto ripristino della foresta. Il comodino nabè è stato progettato per poter essere utilizzato nel letto zeropiù in tutte le fasi della crescita. E\' disponibile integrato alla sponda protettiva laterale (per lato destro o lato sinistro del letto) oppure nella versione "free standing" (cioè adatto a un letto senza sponde) per i bambini più grandi. L\'ingombro effettivo del comodino fuori dal profilo del letto è di 36,5 cm di larghezza x 21,5 cm di profondità, sia nella versione per la sponda protettiva che nella versione "free standing". Lo spazio utile di appoggio è di 36,5 cm larghezza x 28,5 cm profondità. Avvertenze: Il comodino nabè per letto zeropiù è molto resistente e realizzato ad arte con perni e ingegnosi fissaggi interni per resistere alle possibili leve e sollecitazioni dei bambini. Non è comunque da considerarsi uno scalino, una seduta o da usare diversamente dal suo scopo. Il comodino nabè per letto montessoriano zeropiù può essere pulito a necessità con un panno umido , senza ulteriori detergenti. In caso di macchie basterà una passata con una carta vetrata fina lungo la venatura del legno per riportarlo alle origini.',
  category: 'accessori'
},
'Avvolgicavo per Luce nabè': {
  handle: 'avvolgicavo-per-luce-nabe',
  name: 'Avvolgicavo per Luce nabè',
  description: 'Avvolgicavo per Luce nabè. Crea un\'atmosfera morbida e rassicurante per accompagnare la routine della buonanotte. Si integra armoniosamente con gli altri elementi Nabè per uno spazio di crescita coerente.',
  category: 'accessori'
},
'Comodino bio paint per letto evolutivo zero+': {
  handle: 'comodino-bio-paint-per-letto-evolutivo-zero',
  name: 'Comodino bio paint per letto evolutivo zero+',
  description: 'Comodino bio paint nabè per letto montessoriano zero+ Completa il tuo letto zero+ con l\'iconico comodino nabè! Un prodotto unico progettato per integrarsi perfettamente con il letto zeropiù e proposto in due varianti: Comodino integrato alla sponda protettiva nabè, pensato per i bambini più piccoli e disponibile per lato destro e sinistro del letto; Comodino per letto senza sponde , posizionabile con la vite in dotazione ai 4 lati del letto oppure senza vite all\'altezza che preferisci. Il comodino nabè è sicuro! E\' realizzato in legno massello e dotato di sistema di ancoraggio alla struttura e di staffa angolare di supporto che lo rende super resistente! Il comodino nabè è comodo! E\' studiato delle dimensioni ideali per contenere tutti gli oggetti che utilizziamo vicino al letto, da bambini e da grandi. Il comodino nabè è bello! Si integra perfettamente con il design del letto montessoriano zeropiù e la sua forma tondeggiante è un piacere per gli occhi. Il comodino nabè è realizzato in Italia con pregiato legno massello di abete di Svezia , privo di formaldeide, solventi e di ogni sostanza additiva. 100% legno naturale selezionato, certificato FSC per garantire all\'origine un corretto ripristino della foresta. Il comodino nabè è stato progettato per poter essere utilizzato nel letto zeropiù in tutte le fasi della crescita. E\' disponibile integrato alla sponda protettiva laterale (per lato destro o lato sinistro del letto) oppure nella versione "free standing" (cioè adatto a un letto senza sponde) per i bambini più grandi. L\'ingombro effettivo del comodino fuori dal profilo del letto è di 36,5 cm di larghezza x 21,5 cm di profondità, sia nella versione per la sponda protettiva che nella versione "free standing". Lo spazio utile di appoggio è di 36,5 cm larghezza x 28,5 cm profondità. Avvertenze: Il comodino nabè per letto zeropiù è molto resistente e realizzato ad arte con perni e ingegnosi fissaggi interni per resistere alle possibili leve e sollecitazioni dei bambini. Non è comunque da considerarsi uno scalino, una seduta o da usare diversamente dal suo scopo. Il comodino nabè per letto montessoriano zeropiù può essere pulito a necessità con un panno umido , senza ulteriori detergenti. In caso di macchie basterà una passata con una carta vetrata fina lungo la venatura del legno per riportarlo alle origini.',
  category: 'accessori'
},
